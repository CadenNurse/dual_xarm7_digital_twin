...
def launch_setup(context, *args, **kwargs):
    ...
    xarm_moveit_config_share = get_package_share_directory('xarm_moveit_config')

    dual_arm_ros2_controllers_path = os.path.join(
        xarm_moveit_config_share,
        'config',
        'dual_arm',
    ...
    # Added to ensure correct trajecory is chosen and not ambiguous
